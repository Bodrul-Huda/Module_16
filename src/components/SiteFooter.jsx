      ...
      <footer className="text-gray-600 body-font bg-black">
        <div className="container px-5 py-24 mx-auto flex md:items-center justify-between lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col">
          <div className="w-64 flex-shrink-0 md:mx-0 mx-auto text-center md:text-left">
            <a className="flex title-font  font-bold items-center md:justify-start justify-center text-white docs-creator">
              <span className="ml-3 text-3xl">WEB LOGO</span>
            </a>
            ...
            <p className="text-white mt-20">Copyright Design Agency 2022</p>
          </div>
          <div>
            <p className="text-white mb-4 ">Quick Links</p>
            <p className="text-white font-thin py-2">Services</p>
            <p className="text-white font-thin py-2">Portfolio</p>
            <p className="text-white font-thin py-2">About Us</p>
            <p className="text-white font-thin py-2">Contact Us</p>
          </div>
          <div>
